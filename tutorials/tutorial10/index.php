    ...
    <ul>
        <?php
            while($row = $result -> fetch_assoc()){
                //print_r($result);
          ?>
          <li style = 'font-size : 24px; color:bule'>
                <?= $row['id'].' '.$row['username'].' '.$row['password'].' '.$row['birthday'].' '.$row['country'].' '.$row['state'].' '.$row['city'] ?>
          </li>
        <?php
            } 
        ?>
 ...
 <!--   <div class="container">
        ...
        <table class="table" border="1">
            ...
            <!--    <td>1</td>
                    ...
                    <td>Rajkot</td>
                    <td>
                        <a href="registration.html" ><button type="button" class="btn btn-success">Edit</button></a>&nbsp;
